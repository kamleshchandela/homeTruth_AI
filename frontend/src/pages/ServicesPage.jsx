    ...
    <div className="bg-[#0F0905] min-h-screen pt-32 pb-20 px-6 lg:px-12 selection:bg-amber-primary/30">
      ...
      <div className="max-w-[1800px] mx-auto relative z-10">
        ...
        <div className="mb-32">
          ...
          <div className="flex gap-6 overflow-x-auto pb-8 pt-4 px-2 -mx-2 no-scrollbar scroll-smooth">
            {categories.map((cat, i) => {
              ...
              return (
                <motion.button
                  ...
                  className={`group relative flex-shrink-0 w-44 p-6 rounded-[2rem] transition-all duration-500 flex flex-col items-start border ${
                ...
                >
                  ...
                  {activeCategory === cat.name && (
                    <div className="absolute top-0 right-0 w-32 h-32 bg-amber-primary/10 blur-[40px] rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
                  )}
                  ...
                  <div className={`relative z-10 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-all duration-500 ${
                    ...
                    <cat.icon size={24} strokeWidth={activeCategory === cat.name ? 2.5 : 2} />
                  </div>

                  <div className="relative z-10 text-left w-full">
                    <p className={`text-base font-bold tracking-tight mb-1 transition-colors ${
                      activeCategory === cat.name ? 'text-white' : 'text-white/80 group-hover:text-white'
                    }`}>
                      {cat.name}
                    </p>
                    <div className="flex items-center gap-2">
                      <div className={`w-1.5 h-1.5 rounded-full ${count > 0 ? 'bg-success shadow-[0_0_8px_rgba(34,197,94,0.5)]' : 'bg-white/20'}`}></div>
